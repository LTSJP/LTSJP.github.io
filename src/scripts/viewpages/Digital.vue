<template lang="html">
    <div class="common-con">
        ...
        <div class="commodity-type">
            ...
            <div class="logolist" v-for="item in logoListTop">
                <a href="javascript:;">
                    <img :src="item.child[0].pic" alt="">
                </a>
            </div>
            <div class="logolist" v-for="item in logoListBottom">
                <a href="javascript:;">
                    <img :src="item.child[0].pic" alt="">
                </a>
            </div>
    ...
    export default{
        ...
        mounted(){
            ...
            .then((res) => {
                ...
                this.logoListTop = res.data.data.block[0].multi_block[3].data;
                this.logoListBottom = res.data.data.block[0].multi_block[4].data;
                this.shopListTit = res.data.data.block[0].multi_block[5].data;
            }),
            axios.get('./vip/digitalbottom.php')
            .then((res) => {
