...
<script type="text/javascript">
    ...
    export default{
        ...
        mounted(){
            axios.get('/vip/deliciousfoodtop.php')
            .then((res) => {
                ...
                this.recommend1 = res.data.data.block[0].multi_block[3].data[0].child;
                this.recommend2 = res.data.data.block[0].multi_block[3].data[1].child;
                this.shopListTit = res.data.data.block[0].multi_block[4].data;
            }),
            axios.get('./vip/deliciousfoodbottom.php')
            .then((res) => {
